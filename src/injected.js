...
var functions = {
    subbox: function goToSubs() {
        window.location.href = "https://www.youtube.com/feed/subscriptions";
    },

    user: function goToUser() {
    ...
    like: function pressLike() {
        var button = $('.like-button-renderer-like-button');
        click(button);
    },
    dislike: function pressDislike() {
    ...
    tabRight: function pressTabLeft() {
